define(["require", "exports", "./lib/typescriptServicesMetadata"], function (require, exports, typescriptServicesMetadata_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    function createAPI() {
        return {
            ...
            ScriptTarget: ScriptTarget,
            ModuleResolutionKind: ModuleResolutionKind,
            typescriptVersion: typescriptServicesMetadata_1.typescriptVersion,
