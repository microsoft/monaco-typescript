define(["require", "exports", "assert", "../src/tokenization"], function (require, exports, assert, tokenization_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    suite('tokenization', function () {
        function executeTokenizationTests(tests) {
            var tokenizationSupport = tokenization_1.createTokenizationSupport(tokenization_1.Language.EcmaScript5);
